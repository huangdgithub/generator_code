...
import com.mf.glory.entity.ColumnEntity;
import com.mf.glory.entity.TableEntity;
...
public class GeneratorUtils {
	...
	public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip){
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.wakeup" : mainPath;

		//封装模板数据
		Map<String, Object> map = new HashMap<>();
		map.put("tableName", tableEntity.getTableName());
		map.put("insertSql", tableEntity.getInsertSQL());
